...
function Login() {
	...
	const [showErrorModalMessage, setShowErrorModalMessage] = useState(false)
		...
		<div>
			<div className="h1-header">SIGN IN</div>
			{
				isEmpty(userData) ? <div>
						...
						<ModalErrorMessage show={showErrorModalMessage} text={errorMessage}/>
					</div>
